# Instagram Authentic Prompting (Anti-Aesthetic)

> Transform AI-generated images from "too perfect" to "authentically casual"
>
> **Last updated:** 2025-11-28 (v0.3)
> **Related:** 01_photorealistic_prompting_v03.md (complementary approach)
> **Purpose:** Create realistic social media imagery by embracing imperfection

---

## Table of Contents

0. [The POV Decision Framework](#0-the-pov-decision-framework) ⭐ CRITICAL
...
4. [Prompt Formula Example](#4-prompt-formula-example)
5. [Directing Notes](#5-directing-notes)
6. [Model-Specific Adaptations](#6-model-specific-adaptations)
7. [Scenario Templates](#7-scenario-templates)
8. [Complete Example](#8-complete-example)
9. [Layer Application Checklist](#9-layer-application-checklist)
10. [Story vs Feed](#10-story-vs-feed)
11. [When to Use This Guide](#11-when-to-use-this-guide)
...
- Full-body framing + complex background required

**Visual markers:**
- `NO phone visible in shot`
- `shot by friend` or `photographer taking photo`
- `natural hand placement` (not holding phone)
- Can specify camera: `shot on Canon EOS R5` or `shot on friend's iPhone`
...
**Step 3:** Apply imperfection layers (2-5) appropriate to that POV:
...
| Traditional Photorealistic | Anti-Aesthetic (THIS GUIDE) |
|---------------------------|----------------------------|
| Professional camera settings | Smartphone limitations |
| Perfect lighting | Harsh, unflattering lighting |
| Studio quality | Everyday chaos |
| Flawless execution | Authentic imperfection |
| Clean backgrounds | Lived-in, messy spaces |
| Soft bokeh | Flat focus, deep depth of field |
...
Apply these **5 layers** to convert "AI Art" to "Instagram Content."

| Layer | Purpose | Key Keywords | When to Use |
|-------|---------|--------------|-------------|
| **A: Aggressive Flash** | Harsh, reality-exposing light | `direct on-camera flash`, `harsh flash`, `hard shadows`, `starburst flash reflection`, `red-eye effect`, `nightlife photography` | Selfies, indoor low-light, party/night scenes |
| **B: Dirty Optics** | Real cameras/mirrors are rarely clean | `dirty mirror`, `fingerprints on glass`, `dust particles on lens`, `smudged lens`, `greasy lens flare`, `water spots`, `flash reflection obscuring face`, `wiped circle in steam` | Mirror selfies, bathroom, post-shower, gym |
| **C: Trashy Background** | Lived-in spaces, not studios | `cluttered bedroom`, `pile of clothes on chair`, `unmade bed`, `messy vanity`, `random cables`, `cardboard boxes`, `laundry drying`, `everyday objects` | Home settings, casual environments |
| **D: Motion & Focus Failures** | Phones don't focus perfectly | `motion blur`, `shutter drag`, `out of focus hand`, `blurry face`, `camera shake`, `low shutter speed`, `slight noise`, `grainy ISO` | Candid moments, action shots, low-light |
| **E: The Phone Prop** | Phone is part of the story | `mirror selfie`, `holding iPhone 15 Pro`, `phone case visible`, `fingers covering lens`, `flash flare masking phone` | All selfies and mirror shots |

**Example layer combination (Mirror Selfie):**
```
mirror selfie, holding iPhone, fingerprints on mirror (Layer B), harsh flash creating starburst (Layer A), unmade bed in background (Layer C), phone case visible (Layer E)
```
...
### Digital Artifacts (Use Sparingly)
...
## 4. Prompt Formula Example

### The "Fit Check" Mirror Selfie

**POV:** Selfie (mirror)
**Camera:** iPhone
**Scenario:** Bedroom, bathroom, gym changing room, store fitting room
...
Perfect smiles look staged. Use instead:
- `bored expression`
- `deadpan`
- `mouth slightly open`
...
Phone cameras have deep depth of field:
- `flat focus`
- `everything in focus`
- `deep depth of field`
...
**POV:** Selfie (holding phone) | **Camera:** iPhone front-facing

**Essential elements:** Messy hair, rumpled sheets, natural window light, no makeup, sleepy expression
...
**Imperfections:** Soft focus, natural skin texture, overexposed window, casual cropping

---

### Post-Shower Bathroom Mirror

**POV:** Mirror selfie (ALWAYS) | **Camera:** iPhone

**Essential elements:** Steamy mirror OR wiped circle, wrapped in towel, water droplets, harsh bathroom lighting
...
**Imperfections:** Steamy mirror blur, flash glare, harsh overhead light, water spots

---

### Bedroom Lingerie/Intimate Check

**POV:** Mirror selfie (NEVER third-person) | **Camera:** iPhone

**Essential elements:** Bedroom mirror, casual pose, messy bedroom background, soft lighting or window, flash reflection
...
**Imperfections:** Dirty mirror (fingerprints), flash starburst, messy bedroom background, casual framing
...
## 9. Layer Application Checklist

When converting any prompt to "anti-aesthetic" style:

- [ ] **Layer A:** Add harsh flash (`direct flash`, `hard shadows`)
...
- [ ] **Model:** Adapt length and style for target model (see Section 6)
...
|--------|-----------|------------|
| **Lifespan** | Permanent (until deleted) | Ephemeral (24 hours) |
| **Purpose** | Curated, intentional content | Raw, spontaneous moments |
| **Style** | Polished BUT authentic | Fully embrace imperfections |
| **Composition** | Follows grid aesthetic | Casual, "in the moment" |
| **Quality expectation** | Higher, more intentional | Lower quality is MORE authentic |
...
Use **selective imperfections** (2-3 elements maximum):
...
Use **ALL imperfections** freely (4-7 layers):
...
### Example Comparison: Same Scenario
...
**The difference:**
- **Feed:** Curated "morning moment" (planned to look effortless)
- **Story:** Actual morning chaos captured in 2 seconds

---

## 11. When to Use This Guide
...
**Use THIS guide (07) when you want:**
...
✅ iPhone/smartphone photography look
✅ Everyday moments (morning routines, coffee, OOTD)
✅ Stories and casual Feed posts

**Use 01_photorealistic_prompting_v03.md when you want:**
...
**Version:** 3.0
**Last Updated:** 2025-11-28 (v0.3 Migration - Consolidated from 920 → 450 lines)
